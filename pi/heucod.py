...
# USAGE #
# Heucod is an event standard used on the Raspberry Pi to convert MQTT messages into a format that allows for multiple
# databases to interface with the system.
#
# As the developers have not coded the file themselves or developed the standard, this file will not be commented. The
# reader is, however, urged to visit the documentation by Stefan Wagner, "HEUCOD draft recommendation", 2020.
import json
...
class HeucodEventType(Enum):
    ...
    CookingDeviceUsage = (82136, "OpenCare.EVODAY.DeviceUsageEvent.CookingDeviceUsage") #Denne skal bruges
    ...
    LowActivityWarning = (82206, "OpenCare.EVODAY.Notifications.LowActivityWarning") #Denne skal bruges
